...
{
    /// <summary>
    /// function mapper, return double, with 3 parameters.
    ...
    public class Func3ParamsRetDoubleMapper<TP1, TP2, TP3> : FunctionParamsMapperBase
    {
        public Func3ParamsRetDoubleMapper()
        {
        ...
        /// return a double.
        /// </summary>
        public Func<TP1, TP2, TP3, double> Function { get; private set; }
        ...
        public bool SetFunction(Func<TP1, TP2, TP3, double> func)
        {
            Function = func;
