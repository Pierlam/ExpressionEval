...
{
    /// <summary>
    /// function mapper, return string, with 3 parameters.
    ...
    public class Func3ParamsRetStringMapper<TP1, TP2, TP3> : FunctionParamsMapperBase
    {
        public Func3ParamsRetStringMapper()
        {
            base.ReturnType = DataType.String;
            base.ParamsCount = 3;
        }
        ...
        /// return an int.
        /// </summary>
        public Func<TP1, TP2, TP3, string> Function { get; private set; }
        ...
        public bool SetFunction(Func<TP1, TP2, TP3, string> func)
        {
            Function = func;
